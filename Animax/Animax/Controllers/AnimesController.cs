...
namespace Animax.Controllers
{
    public class AnimesController : Controller
    {
        ...
        public AnimesController(Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao")] Anime anime)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descricao")] Anime anime)
        {
            if (id != anime.Id)
            {
                return NotFound();
