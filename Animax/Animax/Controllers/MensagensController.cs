...
namespace Animax.Controllers
{
    public class MensagensController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,Descricao,CreatedDate")] Mensagem mensagem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,Descricao,CreatedDate")] Mensagem mensagem)
        {
            if (id != mensagem.Id)
            {
                return NotFound();
