...
namespace Animax.Controllers
{
    public class ComentariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,Descricao,CreatedDate,Autor")] Comentario comentario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,Descricao,CreatedDate,Autor")] Comentario comentario)
        {
            if (id != comentario.Id)
            {
                return NotFound();
